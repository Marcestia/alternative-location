...
INSERT INTO "new_Quote" ("clientId", "contactRequestId", "createdAt", "endDate", "eventDate", "id", "notes", "pdfUrl", "quoteNumber", "signatureData", "signedAt", "signedName", "startDate", "status", "token", "totalAmountCents", "updatedAt") SELECT "clientId", "contactRequestId", "createdAt", "endDate", "eventDate", "id", "notes", "pdfUrl", "quoteNumber", "signatureData", "signedAt", "signedName", "startDate", "status", "token", "totalAmountCents", "updatedAt" FROM "Quote";
DROP TABLE "Quote";
